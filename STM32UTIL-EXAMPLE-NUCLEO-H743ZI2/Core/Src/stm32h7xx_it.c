...
#if STM32UTIL_HCMS_SPI_USE_LL
	if (LL_SPI_IsActiveFlag_EOT(STM32UTIL_HCMS_SPI)) {
		LL_SPI_ClearFlag_EOT(STM32UTIL_HCMS_SPI);
		LL_SPI_ClearFlag_TXTF(STM32UTIL_HCMS_SPI);
		LL_SPI_Disable(STM32UTIL_HCMS_SPI);
		STM32UTIL_HCMS_SPI_TC_isr();
	}
#endif
